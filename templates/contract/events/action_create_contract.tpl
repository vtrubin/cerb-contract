<b>{'contract.model.title'|devblocks_translate|capitalize}:</b><br>
<div style="margin-left:10px;margin-bottom:0.5em;">
    <input type="text" name="{$namePrefix}[title]" size="45" value="{$params.subject}" style="width:100%;" class="placeholders">
</div>

<b>{'contract.model.org'|devblocks_translate|capitalize} #:</b><br>
<div style="margin-left:10px;margin-bottom:0.5em;">
    <input type="text" name="{$namePrefix}[org]" size="45" value="{$params.phone}" style="width:100%;" class="placeholders">
</div>
...
{include file="devblocks:cerberusweb.core::internal/decisions/actions/_shared_add_custom_fieldsets.tpl" context=CerberusContexts::CONTEXT_CONTRACT field_wrapper="{$namePrefix}"}
...
{capture name="object_vars"}
    {foreach from=$trigger->variables item=var key=var_key}
        {if $var.type == "ctx_{CerberusContexts::CONTEXT_CONTRACT}"}
